...
<!-- GENERATED from .claude/agents/builder.md + docs/orchestra/orca-runtimes.json — DO NOT EDIT THIS FILE.
...
**This is the `builder-frontend` lane of `builder`** — the model matrix varies the runtime and model for this lane, never the brief above.

## Rules that do not travel — read them yourself

Claude preloads these as skills; OpenCode has no such preload, so read each file before your first edit. A rule you did not read still binds you.

- `.claude/rules/engine-boundary.md`
- `.claude/rules/e2e.md`
- `.claude/rules/pipeline.md`
- `.claude/rules/migrations.md`
- `.claude/skills/orchestrator/references/standing-rails.md`
