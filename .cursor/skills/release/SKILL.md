---
name: release
description: Main session only. Workers never load this. Ship on any host — draft PRs, merge after review.pr and fast-gate green, execute deploy. Routing: flow.json release.* states.
