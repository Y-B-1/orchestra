...
On `AGENTS.md`: confirm `## How to fill`, `## Orchestra`, and `## Memory` exist. If `## Orchestra` is missing, append the block from `docs/orchestra/AGENTS.framework.md`. Never overwrite filled **Who you are**, **Delivery**, or **Project rails** slots.
